...
## 0. Flagship exploratory finding

**We did not find ancient quantum mechanics.** We found a cleaner story:

1. Vedānta PD English (heuristic v0.3) shows Level I substrate/manifestation structure with **0 historical Q-family positives**.
2. Lucretius shows classical void/composition structure under the same annotator.
3. PD Paramananda contains modern anachronisms (e.g. *electrons*) — scientific-sounding English can be editorial.
4. ΔQ remains ≈ 0; physics controls still show Q-family hits.

See `HEADLINE_FINDING.md` and figures fig32–fig34.
