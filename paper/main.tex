...
Open-model annotation on Kaggle was subsequently authenticated under account \texttt{aks1321}; early GPU batch workers did not attach accelerators, and a CPU oneshot pilot returned uniformly \texttt{NA} labels (model too weak for 36-feature oneshot JSON).
A batched CPU follow-up and GPU unlock (phone verification / UI accelerator) remain part of the exploratory annotation path.
