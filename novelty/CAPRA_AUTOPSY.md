# Flagship finding — Capra claim autopsy
...
### Claim autopsy (Vedānta PD, n=80)

| ID | Verdict | rate Level-I/II | rate Quantum |
|----|---------|-----------------|--------------|
| CAPRA01 | **CONTRADICTED_AS_QUANTUM** | 0.39 | 0.00 |
| CAPRA02 | **CONTRADICTED_AS_QUANTUM** | 0.14 | 0.00 |
| CAPRA03 | **CONTRADICTED_AS_QUANTUM** | 0.10 | 0.00 |
| CAPRA04 | **CONTRADICTED_AS_QUANTUM** | 0.01 | 0.00 |
| CAPRA05 | **CONTRADICTED_AS_QUANTUM** | 0.07 | 0.00 |


**Contradicted-as-quantum:** 5 / 5

### Lexicon ablation

Mean ΔQS after masking modern physics lexicon (Vedānta): **0.0063**

### Irony exhibit

- `PD_VEDANTA__069_f01ebfe5`: Paramananda uses modern scientific vocabulary while arguing that material science is exclusive/limited and cannot yield knowledge of the Infinite (Brahman). Capra-style readings often reverse this: they treat science vocabulary as evidence of Sanskrit↔QM identity.

> The observation of material science being confined to the sense plane, it ignores what is beyond. Therefore it must always be limited and subject to change. It discovered atoms, then it went further and discovered electrons, and when it had found the one, it had to drop the other; so this kind of knowledge can never le…
