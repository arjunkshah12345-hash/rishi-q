...
def run_dev_calibration(root: Path, config_path: Path) -> dict:
    ...
    summary = {
        ...
        "held_out_theory_validation_summary": {
            "evidence_class": "DEVELOPMENT_ANALYSIS",
            "evidence_role": "CURATED_PEDAGOGY_DEVELOPMENT_BENCHMARK",
            "contamination_state": "DEVELOPMENT_CONTAMINATED",
            ...
            "note": "Pedagogy benchmark only; see theory_validation_v2 for external validation.",
        },
        ...
        "warnings": [
            ...
            "Keyword/method_benchmark panels are SOFTWARE_DEMO; pedagogy corpus is DEVELOPMENT_CONTAMINATED.",
            "External theory_validation_v2 final holdout remains UNEVALUATED until method freeze.",
            "Hierarchical power uses provisional variance — sample size not freeze-ready.",
